#Universal 95a. IF there are postpositions, THEN (IF adjectives precede nouns or relatives precede nouns, THEN demonstratives preced nouns and numerals precede nouns) and (IF demonstratives precede nouns or numerals precede nouns, THEN genitives precede nouns).

#N-Adp & (Adj-N | Rel-N) > Dem-N

#GB075:1 & (GB193:1 |  GB328:1) > GB025:1
...
data_frame <- subset(x = GB_wide_strict, select = c("Language_ID", "GB075", "GB193", "GB328", "GB025"))
