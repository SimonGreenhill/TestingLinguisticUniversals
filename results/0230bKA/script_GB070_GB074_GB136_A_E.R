...
#Version B: absent cases + prepositions
# "If cases are absent, THEN the use of prepositions is extensive"
...
for(i in 1:nrow(GB070_GB074_GB136_compl_pruned)){
  if((GB070_GB074_GB136_compl_pruned$GB070[i] == '0') & (GB070_GB074_GB136_compl_pruned$GB072[i] == '0')){GB070_GB074_GB136_compl_pruned$No_Case[i] <- 1}
  else(GB070_GB074_GB136_compl_pruned$No_Case[i] <- 0)
}

GB070_GB074_GB136_compl_pruned2 <- subset(x = GB070_GB074_GB136_compl_pruned, select = c("Language_ID", "No_Case", "GB074"))
