#Universal 174. If a language is prepositional, then if the numeral follows the noun, the genitive follows the noun.

#Adp-N & N-Num > N-Gen

#GB074:1 & GB024:2 > GB065:2
...
data_frame <- subset(x = GB_wide_strict, select = c("Language_ID", "GB074", "GB024", "GB065"))
...
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB074[i] == 1 & data_frame_compl_pruned$GB024[i] == 2)
