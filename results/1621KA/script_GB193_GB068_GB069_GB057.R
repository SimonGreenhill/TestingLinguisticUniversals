...
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB193[i] == 1 | data_frame_compl_pruned$GB193[i] == 2 | data_frame_compl_pruned$GB193[i] == 3 | data_frame_compl_pruned$GB068[i] == 1 | data_frame_compl_pruned$GB069[i] == 1)
...
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB057[i] == 0)
