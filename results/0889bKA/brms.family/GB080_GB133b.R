...
GB079_GB131_compl2 <- subset(x = GB079_GB131_compl, select = c("Language_ID", "worder","Prefixes"))

# write files
setwd(dirname(rstudioapi::getActiveDocumentContext()$path))

write.table(GB079_GB131_compl2, file = "BT_data.txt", sep = "\t", quote = F, row.names = F, col.names = F)
