#Universal 15b. Verbal modifiers like those for negation, causation, and reflexive or reciprocal are placed after verb roots in OV languages and before verb roots in VO languages.

#VO > Mod-V

#(GB131:1 | GB132:1) & GB133:0 > GB138:1
...
data_frame <- subset(x = GB_wide_strict, select = c("Language_ID", "GB131", "GB132", "GB133", "GB138"))
...
#making sure the second set of conditions is met:  GB138:1
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB138[i] == 1)
