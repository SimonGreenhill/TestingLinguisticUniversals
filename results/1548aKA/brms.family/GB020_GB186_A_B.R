...
for(i in 1:nrow(GB020_GB186_compl)){
  if((GB020_GB186_compl$GB131[i] == '0') & (GB020_GB186_compl$GB132[i] == '0') & (GB020_GB186_compl$GB133[i] == '1')) {GB020_GB186_compl$Verb_final[i] <- 1}
  else(GB020_GB186_compl$Verb_final[i] <- 0)
}

GB020_GB186_compl2 <- subset(x = GB020_GB186_compl, select = c("Language_ID", "Verb_final", "NotSeveral_Articles"))
