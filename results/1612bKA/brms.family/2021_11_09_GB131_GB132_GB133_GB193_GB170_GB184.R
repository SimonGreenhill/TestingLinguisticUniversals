...
for(i in 1:nrow(data_frame_compl)){
  if(data_frame_compl$GB131[i] == 0 & data_frame_compl$GB132[i] == 0 & data_frame_compl$GB133[i] == 1 & data_frame_compl$GB193[i] == 2)
...
for(i in 1:nrow(data_frame_compl)){
  if(data_frame_compl$GB170[i] == 1 | data_frame_compl$GB184[i] == 1)
