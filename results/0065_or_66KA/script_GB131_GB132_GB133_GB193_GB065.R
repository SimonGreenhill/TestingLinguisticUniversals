#Universal 65a. If a language has SOV word order, then if the adjective precedes the noun, the genitive precedes the noun. If a language has dominant SOV order and the genitive follows the governing noun, then the adjective likewise follows the noun.

#SOV & Adj-N > Gen-N

#GB131:0 & GB132:0 & GB133:1 & GB193:1 > GB065:1
...
data_frame <- subset(x = GB_wide_strict, select = c("Language_ID", "GB131", "GB132", "GB133", "GB193", "GB065"))
...
#making sure the first set of conditions is met: GB131:0 & GB132:0 & GB133:1 & GB193:1  
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB131[i] == 0 & data_frame_compl_pruned$GB132[i] == 0 & data_frame_compl_pruned$GB133[i] == 1 & data_frame_compl_pruned$GB193[i] == 1)
