...
GB080_GB133_compl2 <- subset(x = GB080_GB133_compl, select = c("Language_ID", "worder","Suffixes"))

# write files

setwd(dirname(rstudioapi::getActiveDocumentContext()$path))

write.table(GB080_GB133_compl2, file = "BT_data.txt", sep = "\t", quote = F, row.names = F, col.names = F)
