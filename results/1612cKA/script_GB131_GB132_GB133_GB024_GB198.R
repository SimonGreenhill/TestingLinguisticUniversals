...
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB131[i] == 0 & data_frame_compl_pruned$GB132[i] == 0 & data_frame_compl_pruned$GB133[i] == 1 & data_frame_compl_pruned$GB024[i] == 2)
...
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB198[i] == 1)
