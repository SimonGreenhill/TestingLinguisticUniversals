#Universal 67. If a language has VSO word order, then if the adjective follows the noun, the genitive follows the noun.

#VSO & N-Adj > N-Gen

#GB131:1 & GB132:0 & GB133:0 & GB193:2 > GB065:2
...
#making sure the first set of conditions is met: GB131:1 & GB132:0 & GB133:0 & GB193:2 
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB131[i] == 1 & data_frame_compl_pruned$GB132[i] == 0 & data_frame_compl_pruned$GB133[i] == 0 & data_frame_compl_pruned$GB193[i] == 2)
...
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB065[i] == 2)
