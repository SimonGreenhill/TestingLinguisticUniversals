#Universal 177. If a language has Postp word order, then if the demonstrative precedes the noun, the genitive precedes the noun.

#N-Adp & Dem-N > Gen-N

#GB075:1 & GB025:1 > GB065:1
...
data_frame <- subset(x = GB_wide_strict, select = c("Language_ID", "GB075", "GB025", "GB065"))
...
#making sure the first set of conditions is met: GB075:1 & GB025:1
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB075[i] == 1 & data_frame_compl_pruned$GB025[i] == 1)
