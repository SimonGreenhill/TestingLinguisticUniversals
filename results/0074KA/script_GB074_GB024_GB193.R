#Universal 74. If a language has Prep word order, then if the numeral follows the noun, the adjective follows the noun.

#Adp-N & N-Num > N-Adj

#GB074:1 & GB024:2 >  GB193:2
...
data_frame <- subset(x = GB_wide_strict, select = c("Language_ID", "GB074", "GB193", "GB024"))
