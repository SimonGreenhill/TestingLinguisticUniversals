...
for(i in 1:nrow(GB020_GB186_compl_pruned)){
  if((GB020_GB186_compl_pruned$GB131[i] == '1') & (GB020_GB186_compl_pruned$GB132[i] == '0') & (GB020_GB186_compl_pruned$GB133[i] == '0')) {GB020_GB186_compl_pruned$Verb_initial[i] <- 1}
  else(GB020_GB186_compl_pruned$Verb_initial[i] <- 0)
}

GB020_GB186_compl_pruned2 <- subset(x = GB020_GB186_compl_pruned, select = c("Language_ID", "Verb_initial", "Several_Articles"))
