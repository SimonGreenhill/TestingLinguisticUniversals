...
for(i in 1:nrow(GB170_GB133_compl)){
  if((GB170_GB133_compl$GB131[i] == '0') & (GB170_GB133_compl$GB132[i] == '0') & (GB170_GB133_compl$GB133[i] == '1')) {GB170_GB133_compl$Verb_final[i] <- 1}
  else(GB170_GB133_compl$Verb_final[i] <- 0)
}

for(i in 1:nrow(GB170_GB133_compl)){
  if((GB170_GB133_compl$GB170[i] == '1') | (GB170_GB133_compl$GB184[i] == '1')) {GB170_GB133_compl$Agreement[i] <- 1}
  else(GB170_GB133_compl$Agreement[i] <- 0)
}

GB170_GB133_compl2 <- subset(x = GB170_GB133_compl, select = c("Language_ID", "Verb_final", "Agreement"))
