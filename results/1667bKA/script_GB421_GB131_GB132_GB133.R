#Universal 1667b. There is a tendency for conjunctions (including comlementizers) to occur in clause-final position in SOV languages and in clause-initial position in VSO languages. 

#Comp-S > VSO

#GB421:1 > GB131:1 & GB132:0 & GB133:0
...
data_frame <- subset(x = GB_wide_strict, select = c("Language_ID", "GB421", "GB131", "GB132", "GB133"))
...
#making sure the first set of conditions is met: GB421:1
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB421[i] == 1)
