...
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB083[i] == 0)
...
for(i in 1:nrow(data_frame_compl_pruned)){
  if(((data_frame_compl_pruned$GB131[i] == 1 | data_frame_compl_pruned$GB132[i] == 1) & data_frame_compl_pruned$GB133[i] == 0) | data_frame_compl_pruned$GB070[i] == 0)
