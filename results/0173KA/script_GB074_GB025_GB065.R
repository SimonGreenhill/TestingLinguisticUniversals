#Universal 173. If a language is prepositional, then if the demonstrative follows the noun, the genitive follows the noun.

#Adp-N & N-Dem > N-Gen

#GB074:1 & GB025:2 > GB065:2
...
data_frame <- subset(x = GB_wide_strict, select = c("Language_ID", "GB074", "GB025", "GB065"))
...
#making sure the first set of conditions is met: GB074:1 & GB025:2
for(i in 1:nrow(data_frame_compl_pruned)){
  if(data_frame_compl_pruned$GB074[i] == 1 & data_frame_compl_pruned$GB025[i] == 2)
