#Universal 110. There is a clear tendency for Rel N languages to be Adj N and for N Rel languages to be N Adj.
...
data_frame <- subset(x = GB_wide_strict, select = c("Language_ID", "GB193", "GB327"))

data_frame_compl <- data_frame[complete.cases(data_frame),]

# prepare datafile

#making sure the first set of conditions is met: GB327:1
